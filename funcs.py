                ...
                if act>1 or (init_human and act==-1):
                    if init_human:
                        if act==-1:
                            ...
                            res=perform_action(state,point,playturn,numofps,opt2)
                            state=res
                    ...
                    if ev.type==MOUSEBUTTONDOWN:
                        ...
                        if act==0:
                            ...
                            if pau:
                                ...
                                drawbutton(screen, "Tạm dừng", 475, 545)
                                screen.blit(font.render("Trò chơi tạm dừng",False, scenery), (600, 590))
                        elif act==1:
                            pygame.event.clear()
                            state.call=-99
                            return state
...
def draw_grid(screen):
    ...
    for i in range (0,6):
        pygame.draw.line(screen,shading,(375+110*i,215),(375+110*i,433),5)
...
def draw_rock(screen,coor,i,j,special=False):#code is for color option; special is for big rock option
    x=coor[0]
    y=coor[1]
    color=()
    if j==0:
